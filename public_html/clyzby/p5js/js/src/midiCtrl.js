 ...
 */
function setElementAttribute(MIDImessageData, timeStamp, triggerSource) {
...
function addNoteHeld(note, timeStamp, element, attr) {
...
function lockAttributes(element) {
 ...
 */
function getNumericValueToSet(ctrlElement, attr, velocity, triggerSource) {
 ...
 */
function getNextVariableOption(ctrlElement, attr) {
 ...
 * @param instanceName
 */
function getCtrlElement(instanceName) {
  switch (instanceName) {
    case 'centerWave':
 ...
 * @param MIDImessage
 */
function knobActive(MIDImessage){
 ...
 * @param MIDImessage
 */
function runSequence(MIDImessage) {
    console.log(MIDImessage);
}
